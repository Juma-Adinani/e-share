        ...
        <div class="modal-content">
            ...
            <form action="{{ route('save-material') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    @else
                    <input type="text" name="material_id" id="" value="1" class="form-control" hidden>
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-md-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group d-flex flex-column">
                                    ...
                                    <select class="js-example-basic-single form-control" id="exam" name="exam_id">
                                        <option value="">select exam type...</option>
                                        @foreach ($exams as $exam )
                                        <option value="{{$exam->id}}" {{old('exam_id') ? 'selected': ''}}>{{$exam->exam_type}}</option>
                                        @endforeach
                                    </select>
                                    @error('exam')
                                    <div class=" text-danger">{{$message}}
