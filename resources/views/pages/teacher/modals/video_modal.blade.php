            ...
            <form action="{{ route('save-material') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <h1 class="alert alert-warning border-0">
                        ...
                        You have got no subjects, you cannot upload exam material!, contact your subject administrator to assign you a subject.
                    </h1>
                    @else
                    <input type="text" name="material_id" id="" value="4" class="form-control" hidden>
