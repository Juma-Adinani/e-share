...
class SchoolController extends Controller
{
    public function getMaterials($id)
    {
        ...
        $materials = ExamMaterialDocument::join('teachers', 'teachers.id', '=', 'exam_material_documents.teacher_id')
            ...
            ->select('exam_material_documents.id as id', 'title', 'subject_name', 'class_name', 'firstname', 'lastname', 'material_type', 'thumbnail', 'exam_material_documents.created_at as posted_at')
